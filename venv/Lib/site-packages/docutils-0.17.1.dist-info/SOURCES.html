...
<div class="document">
    ...
    <p>BUGS.txt
        ...
        docutils/utils/.smartquotes.py.swp
        ...
        test/functional/expected/latex_memoir.tex
        ...
        test/functional/tests/latex_memoir.py
        ...
        tools/test/test_buildhtml.py</p>
</div>
<div class="footer">
    <hr class="footer"/>
    <a class="reference external" href="SOURCES.txt">View document source</a>.
    Generated on: 2020-08-28 10:16 UTC.
    Generated by <a class="reference external" href="http://docutils.sourceforge.net/">Docutils</a> from <a
        class="reference external" href="http://docutils.sourceforge.net/rst.html">reStructuredText</a> source.
